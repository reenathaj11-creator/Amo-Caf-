    ...
    <div className="space-y-8 print:p-0 print:m-0 print:bg-white">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 print:hidden">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-coffee-950">Relatório de Vendas</h2>
            <p className="text-coffee-600 mt-1 font-medium">Histórico de todas as vendas e pedidos realizados.</p>
          </div>
        </div>
        <Button 
          onClick={handlePrint}
      ...
      <div className="print:block hidden mb-8 text-center border-b-2 border-coffee-900 pb-4">
        <h1 className="text-2xl font-black uppercase text-coffee-950">Relatório de Vendas</h1>
      ...
      <Card className="border-none bg-white rounded-2xl shadow-sm">
        <CardHeader>
          <CardTitle className="text-xl text-coffee-950">Vendas do Período</CardTitle>
          <CardDescription className="text-coffee-500">
            {orders.length} vendas encontradas neste mês.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
